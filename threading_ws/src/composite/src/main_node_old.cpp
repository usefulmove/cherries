...
cherry_interfaces::action::Acquisition::Result MainNode::AcquireImage(int frame_id)

{

  auto goal_msg = cherry_interfaces::action::Acquisition::Goal();
...
sensor_msgs::msg::Image MainNode::CombineImages(cherry_interfaces::action::Acquisition::Result images)
{
...
cherry_interfaces::srv::Detection::Response::SharedPtr MainNode::Detect(sensor_msgs::msg::Image image, long frame_id)
{
  auto request =
